            ...
            <c:forEach items="${requestScope.products}" var="product">
                ...
                <div class="card col-lg-3 col-md-4">
                    <div class="product-image">
                        <img style="height:14.5rem;" class="card-img-top"
                             src="./productImages?productID=${product.id}&imageNumber=1" alt="Card image cap">
                        <div class="product-cover"></div>
                        <a class="btn btn-primary inner-view-details"
                           href="http://localhost:9090/ecommerce_war/productprofile?productId=${product.getId()}">View
                            Details</a>
                    </div>
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <h6>
                                <del class="text-secondary">2500.00 EGP</del>
                            </h6>
                        </li>
                    </ul>
                        <%--                <ul class="list-group list-group-flush">--%>
